...
L["Use the '%s' dropdown to pick where you would like to request lists from."] = "Utilisez le menu déroulant '%s' pour choisir un canal où soumettre la requête." 
...
L["Please navigate to the issue tracker."] = "Veuillez vous rendre sur le Bug Tracker."
